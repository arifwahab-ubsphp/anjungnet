                        ...
                        <div class="container mb-4">
                            <form action="<?= base_url('admin-dashboard/menu-store') ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="nama-menu" class="form-label">Menu Name <span
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="jenis-menu" class="form-label">Menu Type <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6" id="additional-sso-field" style="display: none;">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="sso-option" name="sso-option">
                                                ...
                                                <option value="<?= $sso->id ?>"><?= $sso->app_name ?></option>
                                                <?php endif; ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="position-menu" class="form-label">Position Menu <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="status-menu" class="form-label">Menu Status <span
                                                    class="text-danger">*</span></label>
