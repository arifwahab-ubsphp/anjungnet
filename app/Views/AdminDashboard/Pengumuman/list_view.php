                ...
                <tr>                    
                    ...
                    <td style="text-align: center">
                      ...
                      <?php }
                        ...
                        <span><i class="bx bx-mail-send" style="font-size:2rem ; color:#71dd37"></i></span>
                      <?php }                      
                      ?>
                    </td>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href=""><i class="bx bx-edit-alt me-1" style="color:blue"></i> Edit</a>
                                <a class="dropdown-item" href=""><i class="bx bx-trash me-1" style="color:red"></i> Delete</a>
                            </div>
                        </div>
                    </td>
                </tr>
