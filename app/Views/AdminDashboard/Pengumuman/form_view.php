            ...
            <div class="col-xl">
                <div class="card mb-5 test-size">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= base_url('admin-dashboard/news_list') ?>" class="btn rounded-pill btn-secondary"><span class="tf-icons bx bx-left-arrow-circle"></span>&nbsp; Kembali</a>
                    </div>
                    <div class="row">
                        <!-- Basic Layout -->
                        <div class="col-xxl">
                            <div class="card mb-4">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0"></h5>
                                    <small class="text-muted float-end"><span style="color:red">*</span> Wajib diisi</small>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="txt_namanews" name="txt_namanews" placeholder="Nama Pengumuman" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label">Message<b style="color:red">*</b></label>
                                        <div class="col-sm-10">
                                            <textarea id="txt_message" name="txt_message" class="form-control" placeholder="Maksimum 250 patah perkataan"></textarea>
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label">Kategori Pengumuman<b style="color:red">*</b></label>
                                        <div class="col-sm-10">
                                            <select class="form-control form-select" name="cat_news" id="cat_news">
                                                <option value="" <?php if (strcmp('', set_value('cat_news')) == 0) : echo 'selected'; endif; ?>>Sila Pilih..</option>
                                                <?php
                                    ...
                                    <div id="attachment-fields">
                                        <div class="row mb-3 attachment-field">
                                            ...
                                            <div class="col-sm-2">
                                                <button type="button" class="btn btn-outline-primary add-attachment-btn">Tambah Lampiran</button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12" style="text-align: center; padding-bottom: 20px">
                            <button type="submit" id="btn_draf" name="btn_draf" class="btn rounded-pill btn-secondary" value="btn_draf">Draf</button>
                            <button type="submit" id="btn_submit" name="btn_submit" class="btn rounded-pill btn-primary" value="btn_submit">Simpan & Hantar Email</button>
                            <button type="button" id="btn_reset" name="btn_reset" class="btn rounded-pill btn-warning" value="btn_reset">Reset</button>
                        </div>
                    </div>
                    <?= form_close(); ?>
                    <script>
