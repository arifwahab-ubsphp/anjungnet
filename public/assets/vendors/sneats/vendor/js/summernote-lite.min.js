        ...
        i.a.extend(i.a.summernote.lang, {
          "en-US": {
            ...
            link: {
              ...
              url: "To what URL/Path should this link go?",
              buttonSearchResource: "Browse Resources",
                ...
                var t = this.options.dialogsInBody
                  ...
                  e = [
                    ...
                    '<input id="note-dialog-link-url-'.concat(
                      this.options.id,
                      '" class="note-link-url form-control note-form-control note-input" type="text" value="http://"placeholder="Paste URL here"/><br>',
                      '<button type="button" id="browse-resource-btn" class="btn btn-secondary mt-2">'.concat(
                        this.lang.link.buttonSearchResource,
                        "</button>"
                      )
                    ),
                    "</div>",
      ...
      var h = (function () {
        ...
        D = function (t) {
          var e =
              ...
              t.id +
              '" class="note-link-url note-input" type="text" value="http://"placeholder="Paste URL here"/></div>' +
              (t.disableLinkTarget
                ? ""
